# V17 Resume Intelligence - Candidate Receipt
...
Upgrade the V16 resume from a truthful technical summary into a fully calibrated resume system with separate human, ATS, and machine interfaces. The factual identity remains invariant; presentation and retrieval surfaces change by audience.
...
The resume now presents one identity through distinct profiles:
...
- **Machine:** exact identities, dates, evidence states, test totals, project limits, and source URLs.
