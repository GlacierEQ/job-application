...
**Forward-Deployed AI Engineer | Internal AI Platform Architecture | Construction Operations**

Honolulu, Hawaiʻi | U.S. Remote | 808-936-5654 | glacier.equilibrium@gmail.com  
[Portfolio](https://casey-barton-glaciereq.vercel.app/) | [GitHub](https://github.com/GlacierEQ) | [Systems Atlas](https://casey-barton-glaciereq.vercel.app/atlas/)
...
### Job Application Helix - Internal Application-Intelligence Platform
[Repository](https://github.com/GlacierEQ/job-app-helix)

- Designed a typed control plane connecting research, repository evidence, truthful résumé generation, portfolio presentation, package state, and follow-up.
- Models source presence, review, test evidence, promotion, visibility, and release independently so downstream teams cannot inherit unsupported claims.
...
### Agent Coordinator - Reusable Multi-Step Workflow Orchestration
[Repository](https://github.com/GlacierEQ/anthropic-agent-coordinator)

- Built deterministic task orchestration with typed work, dependencies, cycle detection, aggregate role capacity, global token budgets, stable priority, explicit deferral, and no partial-completion unlocks.
- Current recorded evidence includes **62/62 Python tests**; hosted multi-version promotion remains separately gated.

### Portfolio Receipt Router - Evaluation, Governance, and Release Evidence
...
- Validates evidence states, reconciles tests and artifacts, blocks incomplete candidates, routes bounded public claims, and performs no external action.
- **69/69 tests passed** through direct and reusable CI; recorded artifact `8910423397`; **zero external queries and actions**.

### AKOS / Infinity Stone Forge - Shared Architecture and Operating Standards
...
- Provides governed specialist modes for audience calibration, résumé generation, website architecture, and repository-scale reasoning.
- Current Website Masterclass and Monolith extensions remain candidate work until their new Forge, browser, privacy, and production-reconstruction gates pass.
...
- Inspected residential structural, roofing, electrical, plumbing, HVAC, moisture, and safety systems; translated incomplete field evidence into clear, prioritized reports and practical next actions.
- Diagnosed interacting-system failures under time pressure and communicated risk, uncertainty, tradeoffs, and repair priorities to non-technical clients.
- Developed the field discipline now applied to AI systems: inspect the whole workflow, distinguish symptom from cause, preserve evidence, and make the result usable by the person responsible for acting on it.

### Hi-Class Home Services / Hi Class Maintenance Oahu LLC - Owner-Operator
**Honolulu, Hawaiʻi | 2017-Present**

- Scope repair and maintenance work, prepare estimates, coordinate execution, and communicate assumptions, constraints, tradeoffs, and completion status.
- Translate incomplete customer needs into bounded work packages across carpentry, plumbing, electrical fixtures, drywall, painting, flooring, and maintenance planning.
- Own prioritization, customer communication, quality review, and handoff.
