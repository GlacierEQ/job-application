...
const EXPECTED_BUNDLE_MODULE_COUNT = 17;
...
function main() {
  ...
  try {
    ...
    requireValue(bundle.includes('api/workflow-verification-sources.generated.js'), 'effective_bundle_generated_registry_module_missing');
    requireValue(bundle.includes('GENERATED from config/workflow-verification-sources.json'), 'effective_bundle_generated_registry_marker_missing');
