...
assert(sha256(pdf) === '82211eb1d260346901e337eeeca8fb984eaddc578b409c5236d9c241c555bcad', 'resume PDF SHA drift');
assert(docx.subarray(0,2).toString('ascii') === 'PK' && docx.length > 30000, 'resume DOCX invalid');
assert(sha256(docx) === '54abf8eedfa7ac69f44055764299d47c7447d01b2f5a477ac87ec8bbf5dd9596', 'resume DOCX SHA drift');
